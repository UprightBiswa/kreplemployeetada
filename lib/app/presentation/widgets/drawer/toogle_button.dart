...
class ToggleButtonState extends State<ToggleButton> {
  ...
  void initState() {
    super.initState();
    xAlign = widget.currentTheme == 'dark' ? darkAlign : lightAlign;
    lightColor = widget.currentTheme == 'light' ? selectedColor : normalColor;
    darkColor = widget.currentTheme == 'dark' ? selectedColor : normalColor;
  }
